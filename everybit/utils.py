...
def make_request(url, method='GET', data={}):
    ...
    try:
        ...
        message="%s We were unable to communicate with the Everybit API. \
         Is your API key set?  \
         Are you passing in correctly formatted data?" % e
        raise APIConnectionError(message=message)
